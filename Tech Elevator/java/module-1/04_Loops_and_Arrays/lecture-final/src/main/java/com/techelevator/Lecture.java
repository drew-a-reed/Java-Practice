...
public class Lecture
{
    ...
    */
    ...
    /*
    7. What will the variable result be at the end of the method?
       Change the number in the logic expression so that
       it returns true.
    */
    ...
    */
    ...
    /*
    9. How many times do we go through this loop? Change the number in
    ...
    */
    ...
    12. We want this loop to only count every other item starting at zero.
        What needs to change in the loop for
        it to do that?
    */
