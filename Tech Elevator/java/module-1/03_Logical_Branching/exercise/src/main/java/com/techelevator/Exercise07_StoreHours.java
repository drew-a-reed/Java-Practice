...
//        char Saturday = 'S';
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer)
    {
        ...
        {
            return true;
        } else return currentHour >= 9 && currentHour < 15 && isSummer;
    }

//    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
//        if ((currentHour >= 8 && currentHour < 17) && (currentDay != 'S')) {
//            return true;
//        } else if ((currentHour >= 8 && currentHour < 20) && (currentDay != 'S') && (currentDay != 'M') && (currentDay != 'F') && isSummer)  {
//            return true;
//        } else if ((currentHour >= 9 && currentHour < 15) && (currentDay != 'W') && (currentDay != 'M') && (currentDay != 'F') && isSummer) {
//            return true;
//        }
//        return false;
//    }
