...
public class Exercise06_ElectricBill
{
    ...
    public double calculateElectricBill(double unitsUsed)
    {
        ...
        double normalRate = unitsUsed * BASE_RATE;
        double excessHours = unitsUsed - 100;
        // double excessNormalHours = ;
        double excessRate = (excessHours * EXCESS_RATE) + (BASE_RATE * 100);
    ...
    public double calculateElectricBill(double unitsUsed, double unitsReturned)
    {
        ...
        {
            double unitsCharged = (unitsUsed - unitsReturned);
            return calculateElectricBill(unitsCharged) * 0.95;
        } else if ((unitsUsed - unitsReturned) < 0)
        {
