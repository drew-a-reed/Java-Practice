...
public class Lecture
{
    ...
    */
    ...
    public String returnAdultOrMinorOrTeenOption2(int age)
    {
        boolean isAdult = age >= 18;
        boolean isTeen = (age >= 13) && (age <= 17);
//        isTeen = true && age < 17;
...
//
    ...
    // This is an example of how to use the exclusive OR
    // in this example a person is only eligible if they
    // are a coach OR a player, but they cannot be both
    public boolean returnStatus(boolean isCoach, boolean isPlayer)
    {
        boolean isEligible = isCoach ^ isPlayer;
